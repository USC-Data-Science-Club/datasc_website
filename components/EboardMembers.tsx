export default function EboardMembers() {
  const members = [
    ...
    { name: "Matthew Hall", role: "Head of Curriculum", image: "/Matthew.jpeg", studying: "Applied Mathematic & Data Science", linkedin: "https://www.linkedin.com/in/matthew-hall-350a19b1/" },
